    ...
    override fun Content() {
        ...
        val items = listOf(
            Preference.PreferenceItem.ListPreference(
                ...
                title = stringResource(MR.strings.pref_auto_reread_behaviour_title),
            ),
            Preference.PreferenceItem.ListPreference(
                ...
                entries = AutoRereadResetMode.entries
                    ...
                    .toPersistentMap(),
                title = stringResource(MR.strings.pref_auto_reread_reset_to),
            ),
        )
        ...
        Scaffold(
            topBar = {
                AppBar(
                    title = stringResource(MR.strings.pref_auto_reread_behavior),
